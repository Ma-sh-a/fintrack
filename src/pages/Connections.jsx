...
function generateApiKey(uid) {
  const raw = btoa(unescape(encodeURIComponent(uid))).replace(
    /[^a-zA-Z0-9]/g,
    "",
  );
    ...
    <div className="page">
      ...
      <div className="card">
        ...
        <p className="muted" style={{ marginBottom: 14 }}>
          Демо-ключ для подключения внешних сервисов (банков, брокеров) к вашему
          аккаунту FinFlow. Это имитация. Реального API за ключом нет.
        </p>
