  ...
  return (
    <div className="card bank-connect">
      ...
      <p className="muted" style={{ marginBottom: 16 }}>
        Показывает, как выглядела бы автоматическая загрузка операций через Open Banking API. Реального
        соединения с банком нет.
      </p>
      ...
      {step === 'no-categories' && (
        <div>
          <p className="empty-state">
            Сначала добавь хотя бы одну категорию расходов на странице «Категории».
          </p>
          <button className="btn-secondary" onClick={reset}>
            Назад
          </button>
      ...
      {step === 'done' && (
        <div>
          <p>
            Готово — импортировано {importedCount} операций из {bank.name}. Проверь список на странице
            «Операции».
          </p>
          <button className="btn-secondary" onClick={reset}>
